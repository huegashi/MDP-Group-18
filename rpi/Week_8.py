...
from settings import API_IP, API_IMG_IP, API_PORT
...
class RaspberryPi:
            ...
            ## Command: Start Moving ##
                ...
                if message['value'] == "start":
                    ...
                    while self.command_queue.empty():
                        time.sleep(1) #keep waiting for commands to be returned
    ...
    def snap_and_rec(self, obstacle_id_with_signal: str) -> None:
        ...
        url = f"http://{API_IMG_IP}:{API_PORT}/image"
        filename = f"{int(time.time())}_{obstacle_id}_{signal}.jpg"

        con_file = "Week8Config.txt"
        config_file = "/home/rpi/rpi/"  + con_file
    ...
    def request_stitch(self):
        ...
        url = f"http://{API_IMG_IP}:{API_PORT}/stitch"
